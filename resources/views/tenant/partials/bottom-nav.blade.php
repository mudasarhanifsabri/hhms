<nav class="tenant-bottom-nav">
    <a href="{{ route('tenant.dashboard') }}" class="active"><i class="ri-home-5-fill"></i><span>Home</span></a>
    ...
    <a href="{{ route('tenant.dashboard') }}"><i class="ri-user-line"></i><span>Profile</span></a>
</nav>
