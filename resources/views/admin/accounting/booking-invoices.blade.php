...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            <thead class="bg-light-subtle"><tr><th>Invoice</th><th>Type</th><th>Booking</th><th>Guest</th><th>Unit</th><th>Period</th><th>Total</th><th>Paid</th><th>Balance</th><th>Status</th><th>PDF</th></tr></thead>
            <tbody>
            ...
            @empty
                <tr><td colspan="11" class="text-center text-muted py-4">No booking invoices generated yet.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
