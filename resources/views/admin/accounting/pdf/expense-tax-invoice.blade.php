...
<table class="totals"><tr><td>Subtotal</td><td class="right">AED {{ number_format((float)$expense->sale_net_amount,2) }}</td></tr><tr><td>VAT {{ number_format((float)$expense->vat_rate,2) }}%</td><td class="right">AED {{ number_format((float)$expense->sale_vat_amount,2) }}</td></tr><tr class="grand"><td>Total</td><td class="right">AED {{ number_format((float)$expense->sale_gross_amount,2) }}</td></tr></table>
</body></html>
