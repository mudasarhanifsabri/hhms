                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-body">
                            ...
                            @if ($landlord->profile_photo)
                                <div class="mt-2">
                                    <img src="{{ \App\Support\MediaStorage::url($landlord->profile_photo) }}" alt="Profile Photo" width="100" />
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-body">
                            ...
                            @if ($landlord->id_document)
                                <div class="mt-2">
                                    <a href="{{ \App\Support\MediaStorage::url($landlord->id_document) }}" target="_blank">View Current Document</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-body">
                            ...
                            @if ($landlord->id_document_back)
                                <div class="mt-2">
                                    <a href="{{ \App\Support\MediaStorage::url($landlord->id_document_back) }}" target="_blank">View Current Back Side</a>
                                </div>
                            @endif
                        </div>
                    </div>
