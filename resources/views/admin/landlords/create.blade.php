...
<form action="{{ route('admin.landlord.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
             <div class="row">
                         ...
                         <div class="col-12 ">
                              <div class="card">
                                   <div class="card-header">
                                        <h4 class="card-title">Add Landlord Photo & Eid or Passport</h4>
                                   </div>
                                   <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card-body">
                                   ...
                                   <div class="card-body">
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                       ...
                                                       <div class="mb-3">
                                                            <label for="number" class="form-label">Landlord Phone</label>
                                                            <input type="number" id="number"  value="{{ old('phone') }}" name="phone" class="form-control" placeholder="Like (+971 50 123 4567)">
                                             ...
                                             <div class="col-lg-6">
                                                     ...
                                                     <div class="mb-3">
                                                          <label for="number" class="form-label">Landlord EiD/ Passport No</label>
                                                          <input type="number" id="number"  value="{{ old('eid_passport_no') }}" name="eid_passport_no" class="form-control" placeholder="Enter EiD/ Passport No">
                              ...
                              <div class="mb-3 rounded">
                                   <div class="row justify-content-end g-2">
                                        <div class="col-lg-2">
                                            <button id="submitBtn" class="btn btn-outline-primary w-100">Create Landlord</button>
                                        </div>
