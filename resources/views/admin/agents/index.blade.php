                        ...
                        <div class="col-lg-6">
                             <div class="text-md-end mt-3 mt-md-0">
                                  ...
                                  <a href="{{ route('admin.agent.create') }}" class="btn btn-success me-1">
                                    <i class="ri-add-line"></i> New Agent </a>
                             </div>
                        </div>
                   </div>
              </div>
    ...
    <div class="col-xl-12">
         <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                   <div>
                        <h4 class="card-title">All Agents List</h4>
                   </div>
                   ...
                   <div class="d-flex justify-content-start align-items-center mb-3">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.agent.pdf.list') }}" class="dropdown-item">Pdf</a>
                            </div>
                        </div>
                   </div>
                             ...
                             <tbody>
                                @foreach ($agents as $agent)
                                  <tr>
                                       ...
                                       <td>3 Units</td>
                                       <td>{{ $agent->dob ? \Carbon\Carbon::parse($agent->dob)->format('d M Y') : 'N/A' }}</td>
                                       <td><span class="badge bg-success-subtle text-success py-1 px-2 fs-13">Active</span></td>
                                       <td>
                                            <div class="d-flex gap-2">
                                                 <a href="{{ route('admin.agent.show', $agent->id) }}" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                                 <a href="{{ route('admin.agent.edit', $agent->id) }}" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>

                                                 <a href="#" class="btn btn-soft-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $agent->id }}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content shadow-lg border-0 rounded-3">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                <p class="mb-2">Are you sure you want to delete <strong>{{ $agent->name }}</strong>?</p>
