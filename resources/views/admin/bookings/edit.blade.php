    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3"><label class="form-label" for="rent_amount">Rent</label><input type="number" step="0.01" min="0" id="rent_amount" name="rent_amount" value="{{ old('rent_amount', $booking->rent_amount) }}" class="form-control booking-money"></div>
                    <div class="form-check mb-3">
                        <input type="checkbox" class="form-check-input" id="vat_included" name="vat_included" value="1" @checked(old('vat_included', $booking->vat_included))>
                    ...
                    <div class="mb-3"><label class="form-label" for="security_deposit">Security Deposit</label><input type="number" step="0.01" min="0" id="security_deposit" name="security_deposit" value="{{ old('security_deposit', $booking->security_deposit) }}" class="form-control booking-money"></div>
