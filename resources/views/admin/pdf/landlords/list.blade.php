...
<head>
    ...
    <title>Total Landlords List</title>
    ...
    <style>
        ...
        .header {
            ...
            display: flex;
            justify-content: space-between; /* Aligns logo to left and date/time to the right */
            align-items: center;
        }
        .header img { height: 40px; width: auto; } /* Smaller logo */
...
<body>
    ...
    <!-- Header Section -->
    <div class="header">
        <img src="{{ public_path('assets/images/logo-dark.png') }}" style="height: 40px; width: auto;" alt="Company Logo">
        <div class="datetime">
    ...
    <div class="text-center my-3">
        <h4 style="color: #800000; font-weight: bold;">Total {{$totalLandlords}} Landlords in record</h4>
    </div>
    ...
    <div class="footer">
        <p>
            ...
            <i class="ri-global-line"></i> www.company.com | &copy; {{ date('Y') }} Company Name. All rights reserved.
        </p>
    </div>
