...
<form action="{{ route('admin.maintainer.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        ...
        <div class="col-12 ">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Maintainer Photo & Eid or Passport</h4>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="emergency_contact_relationship" data-choices data-choices-groups name="emergency_contact_relationship">
            ...
            <div class="mb-3 rounded">
                <div class="row justify-content-end g-2">
                    <div class="col-lg-2">
                        <button id="submitBtn" class="btn btn-outline-primary w-100">Create Maintainer</button>
                    </div>
                    <div class="col-lg-2">
