                   ...
                   <div class="row justify-content-between">
                        <div class="col-lg-6">
                             <div class="row align-items-center">
                                  ...
                                  <div class="col-lg-4">
                                       <h5 class="text-dark fw-medium mb-0">{{ $totalTenants }} <span class="text-muted"> GuestsMudasar</span></h5>
                                  </div>
                             </div>
                        </div>
                        <div class="col-lg-6">
                             <div class="text-md-end mt-3 mt-md-0">
                                  ...
                                  <a href="{{ route('admin.tenant.create') }}" class="btn btn-success me-1">
                                    <i class="ri-add-line"></i> New Tenant </a>
                             </div>
                        </div>
                   </div>
              </div>
    ...
    <div class="col-xl-12">
         <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                   <div>
                        <h4 class="card-title">All Tenants List</h4>
                   </div>
                   ...
                   <div class="d-flex justify-content-start align-items-center mb-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ route('admin.tenant.pdf.list') }}" class="dropdown-item">Pdf</a>
                        </div>
                    </div>
                </div>
                                  ...
                                  <tr>
                                       <td>
                                            <div class="d-flex align-items-center gap-2">
                                                 <div>
                                                      @if($tenant->profile_photo)<img src="{{ \App\Support\MediaStorage::url($tenant->profile_photo) }}" alt="{{ $tenant->name }}" class="avatar-sm rounded-circle">@else<span class="avatar-sm rounded-circle bg-success-subtle text-success d-inline-flex align-items-center justify-content-center"><iconify-icon icon="solar:user-rounded-bold-duotone" class="fs-22"></iconify-icon></span>@endif
                                                 </div>
                                                 <div>
                                       ...
                                       <td>
                                            <div class="d-flex gap-2">
                                                 <a href="{{ route('admin.tenant.show', $tenant->id) }}" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                                 <a href="{{ route('admin.tenant.edit', $tenant->id) }}" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>

                                                 <a href="#" class="btn btn-soft-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $tenant->id }}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content shadow-lg border-0 rounded-3">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                <p class="mb-2">Are you sure you want to delete <strong>{{ $tenant->name }}</strong>?</p>
