...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <meta name="description" content="Reset your Holiday Homes Management System password." />
                              ...
                              <div class="card-body px-3 py-5">
                                   ...
                                   <div class="px-4">
                                        <form action="{{ route('password.email') }}" method="post" class="authentication-form">
                                             ...
                                             <div class="mb-3">
                                                  <label class="form-label" :value="__('Email')" for="example-email">Email</label>
                                                  <input type="email" id="example-email"name="email" :value="old('email')" class="form-control bg-light bg-opacity-50 border-light py-2" placeholder="Enter your email">
